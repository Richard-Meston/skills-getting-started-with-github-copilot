...
activities = {
    ...
    "Basketball Club": {
        "description": "Train for basketball games and improve court performance",
        "schedule": "Tuesdays, Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["matt@mergington.edu", "claire@mergington.edu"]
    },
    "Art Club": {
        "description": "Explore painting, drawing, and mixed media art projects",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
        "participants": ["nina@mergington.edu", "kelly@mergington.edu"]
    },
    "Drama Club": {
